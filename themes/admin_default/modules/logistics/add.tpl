...
<form class="form_add_bill" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
...
<div class="panel-body">
	...
	<div class="form-group">
			...
			<div class="input-group">
						...
						<input type="text" maxlength="255" class="form-control required" value="{ROW.bill}" name="bill">
			</div>
...
<div class="panel-body">
		...
		<div class="form-group"><div class="input-group">
					<span class="input-group-addon w100">{LANG.document_name}</span>
					<input type="text" maxlength="255" class="form-control required" value="{ROW.document_name}" name="document_name">
		</div></div>	
		
		<div class="form-group"><div class="input-group">
					<span class="input-group-addon w100">{LANG.amount}</span>
		...
		<div class="form-group"><div class="input-group">
					...
					<input type="text" maxlength="255" class="form-control" value="{ROW.weight_document}" name="weight_document" >
		</div></div>	
...
<div class="col-xs-24 col-sm-24 col-md-24">
<div class="panel panel-default">
<div class="panel-heading"><h3> IV.{LANG.price_thuho}</h3></div>
<div class="panel-body">
...
<div class="col-xs-24 col-sm-24 col-md-8">
	<div class="form-group"><div class="input-group">
					<span class="input-group-addon w100">a.{LANG.service_charge}</span>
					<input type="text" maxlength="255" class="form-control " value="{ROW.service_charge}" name="service_charge" >
	</div></div>
	
	<div class="form-group"><div class="input-group">
					<span class="input-group-addon w100">b.{LANG.pays}</span>
					<input type="text" maxlength="255" class="form-control " value="{ROW.pays}" name="pays" >
	</div></div>	
	<div class="form-group"><div class="input-group">
					<span class="input-group-addon w100">c.{LANG.charge_for_collection}</span>
					<input type="text" maxlength="255" class="form-control " value="{ROW.charge_for_collection}" name="charge_for_collection" >
	</div></div>
	
	<div class="form-group"><div class="input-group">
					<span class="input-group-addon w100">d.{LANG.total_charge} (a+b+c)</span>
					<input type="text" maxlength="255" class="form-control " value="{ROW.total_charge}" name="total_charge" >
	</div></div>
	
	<div class="form-group"><div class="input-group">
					<span class="input-group-addon w100">e.{LANG.vat} (d x 10%)</span>
					<input type="text" maxlength="255" class="form-control " value="{ROW.vat}" name="vat" >
	</div></div>
	
	<div class="form-group"><div class="input-group">
					<span class="input-group-addon w100">{LANG.total_money} (d+e)</span>
					<input type="text" maxlength="255" class="form-control " value="{ROW.total_money}" name="total_money" >
	</div></div>
...
<div class="col-xs-24 col-sm-24 col-md-8">	
	<div class="form-group"><div class="input-group">
					<span class="input-group-addon w100">{LANG.total_receivable}</span>
					<input type="text" maxlength="255" class="form-control " value="{ROW.total_receivable}"  name="total_receivable">
	</div></div>
...
<script type="text/javascript">
	...
	$('.form_add_bill select[name=userid]').change(function(){
		var userid = $(this).val();
		var id_bill = $('.form_add_bill input[name=id]').val();
		
		if(userid > 0)
		{
			$.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=add&userid_ajax=' + userid, function(res) {
					$('.form_add_bill select[name=id_store]').html(res);
				});
			
			if(id_bill == 0)
			{
				$.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=add&userid_ajax_admin=' + userid, function(res) {
					$('.form_add_bill input[name=bill]').val(res);
				});
			}
		}
	...
	$('.form_add_bill input[name=bill]').change(function(){
		var bill = $(this).val();
		var id_bill = $('.form_add_bill input[name=id]').val();
		
		if(bill != '')
		{
			$.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=add&check_bill=' + bill +'&id_bill=' + id_bill, function(res) {
					if(res != '')
						alert(res);
				});
	...
	$('.form_add_bill input[name=receive_phone]').keypress(function(){
		...
		var customer_userid = $('.form_add_bill select[name=userid] option:selected').val();
		...
		if(receive_phone != '')
		{
			$.ajax({
				...
				data : { customer_phone : receive_phone, customer_userid : customer_userid},

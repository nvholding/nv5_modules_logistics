...
<div class="no_print"><a href="{LINK}">{LANG.no_data} {LANG.return}</a></div>
...
<div class="col-lg-24 col-md-24  col-xs-24" style="margin-bottom:28px">
<div class="tms">
<div class="rows">
<center>
...
<div> 
<strong>CÔNG TY TNHH GIAO NHẬN VÀ CHUYỂN PHÁT NHANH SÀI GÒN </strong>
</div>
<div> 
